...
var TeacherReader = /** @class */ (function (_super) {
    __extends(TeacherReader, _super);
    function TeacherReader() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    TeacherReader = __decorate([
        core_1.Injectable()
    ], TeacherReader);
    return TeacherReader;
}(GenericReaderService_1.GenericReaderService));
exports.TeacherReader = TeacherReader;
var TeachersComponent = /** @class */ (function (_super) {
    __extends(TeachersComponent, _super);
    function TeachersComponent(readerService) {
    ...
    TeachersComponent = __decorate([
        ...
        __metadata("design:paramtypes", [TeacherReader])
    ], TeachersComponent);
